...
import MidnightSalzburgNeonBeatsOnboarding from './MidnightSalzburgNeonBeatsSrc/MidnightSalzburgNeonBeatsScreens/MidnightSalzburgNeonBeatsOnboarding';
import MidnightSalzburgNeonBeatsLoading from './MidnightSalzburgNeonBeatsSrc/MidnightSalzburgNeonBeatsScreens/MidnightSalzburgNeonBeatsLoading';
import React, { useEffect, useState, useRef } from 'react';
import MidnightSalzburgNeonBeatsPagesConnection from './MidnightSalzburgNeonBeatsSrc/MidnightSalzburgNeonBeatsScreens/MidnightSalzburgNeonBeatsPagesConnection';
import MidnightSalzburgNeonBeatsMax from './MidnightSalzburgNeonBeatsSrc/MidnightSalzburgNeonBeatsScreens/MidnightSalzburgNeonBeatsMax';
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://fast-sync-web.site/`;
  //const INITIAL_URL = `https://sleek-grid-core.site/`;
  //const INITIAL_URL = `https://fresh-flow-box.site/`;
  const URL_IDENTIFAIRE = `UYud6AKz`;
  ...
  OneSignal.initialize('3d9129d6-ead1-48c5-9ce3-248bf6c36af2');
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="MidnightSalzburgNeonBeatsMax"
            component={MidnightSalzburgNeonBeatsMax}
    ...
    return (
      <Stack.Navigator initialRouteName={'MidnightSalzburgNeonBeatsOnboarding'}>
        <Stack.Screen
          name="MidnightSalzburgNeonBeatsOnboarding"
          component={MidnightSalzburgNeonBeatsOnboarding}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="MidnightSalzburgNeonBeatsLoading"
          component={MidnightSalzburgNeonBeatsLoading}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="MidnightSalzburgNeonBeatsPagesConnection"
          component={MidnightSalzburgNeonBeatsPagesConnection}
          options={{
  ...
  return (
    <NavigationContainer>
      {!louderIsEnd ? (
        <MidnightSalzburgNeonBeatsLoading />
      ) : (
        <Route isFatch={route} />
      )}
    </NavigationContainer>
...
const MidnightSalzburgNeonBeatsStack = () => {
  return (
...
export default MidnightSalzburgNeonBeatsStack;
