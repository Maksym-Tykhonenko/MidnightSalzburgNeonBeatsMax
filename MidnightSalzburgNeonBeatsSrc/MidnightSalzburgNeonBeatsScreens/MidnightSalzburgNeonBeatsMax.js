...
const MidnightSalzburgNeonBeatsMax = ({ navigation, route }) => {
      ...
      >
        ...
        >
          <Image
            ...
            source={require('../MidnightSalzburgNeonBeatsAssets/icons/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        >
          <Image
            ...
            source={require('../MidnightSalzburgNeonBeatsAssets/icons/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default MidnightSalzburgNeonBeatsMax;
